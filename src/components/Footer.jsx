      ...
      <div className="container footer-container">
        ...
        <div className="footer-contact">
          ...
          <div className="footer-social">
            <a href="https://wa.me/250784254440" className="social-link" aria-label="WhatsApp">
            ...
            <a href="https://www.instagram.com/best_national_service_ltd/" className="social-link" aria-label="Instagram">
              <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
